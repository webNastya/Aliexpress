document.addEventListener('DOMContentLoaded', () => {
	...
	let cardsData = fetch('db/db.json')
	...
	// 	basketBtn : document.querySelector('#basket-main-btn'),
	// 	favoritesBtn : document.querySelector('#favorites-main-btn'),
	// 	basket : document.querySelector('#basket'),
	//  	category : document.querySelector('#category'),
	//  	basketCounter : basketBtn.querySelector('#counter'),
	//  	favoritesCounter : favoritesBtn.querySelector('#counter'),
	//  	basket : document.querySelector('#basket-wrapper'),
